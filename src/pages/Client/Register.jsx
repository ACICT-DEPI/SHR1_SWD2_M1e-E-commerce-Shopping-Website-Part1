  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 relative">
      ...
      <div className="w-full max-w-xl p-10 space-y-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white">Register to Shopify</h2>
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="relative">
            ...
            {errorMessages.firstName && <div className="text-red-500">{errorMessages.firstName}</div>}
          </div>
          ...
          <div className="relative">
            ...
            {errorMessages.phone && <div className="text-red-500">{errorMessages.phone}</div>}
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full px-4 py-3 pl-10 border ${errorMessages.password ? "border-red-500" : "border-gray-300"} dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500`}
            />
          ...
          <div className="relative">
            ...
            />
            <AiOutlineLock className="absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-500 dark:text-gray-400" />
            {errorMessages.confirmPassword && <div className="text-red-500">{errorMessages.confirmPassword}</div>}
          </div>

          {/* Register Button */}
          <button
            type="submit"
            className={`w-full py-3 font-semibold text-white bg-blue-600 rounded-md ${loading ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-700"}`}
            disabled={loading}
          >
